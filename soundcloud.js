...
fetch('http://ent/web-sourcemaps/api.js-4950e94a9243.map')
...
export function songChanger () {
        const scrollContainer = document.querySelector("#frames")
